...
const articles = [
    {
        ...
        description: "Microsoft released information regarding a newly discovered vulnerability affecting Windows 11 users. The vulnerability, identified as CVE-2024-12345, allows attackers to execute arbitrary code on affected systems. Users are advised to update their systems immediately to mitigate potential risks.",
        ...
        description: "A recent phishing campaign has been targeting employees of major financial institutions. The attackers are using sophisticated email templates that mimic official communications, aiming to steal sensitive information. Security experts recommend increased awareness and training for employees to recognize phishing attempts.",
        url: "https://www.cisco.com/c/en/us/products/security/what-is-cybersecurity.html"
    },{
        category: "Low",
        title: "New Cybersecurity Framework Released",
        description: "The National Institute of Standards and Technology (NIST) has released an updated cybersecurity framework aimed at helping organizations improve their security posture. The framework provides guidelines for identifying, protecting, detecting, responding to, and recovering from cyber threats.",
        url: "https://www.cisco.com/c/en/us/products/security/what-is-cybersecurity.html"
    }
...
function initializeArticles() {
    ...
    articles.forEach(article => {
        ...
        categoryElement.classList.add(categoryclasses[article.category.toLowerCase()]);
...
initializeArticles();
>>>>>>> a98658375c31c334e443bab668318fec492ef320
